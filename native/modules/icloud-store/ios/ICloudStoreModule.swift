...
// part of the baby log's own logic is reimplemented here. This module
...
private let CONTAINER_ID = "iCloud.se.agilator.baby"
...
/// A baby log is tens of kilobytes, so this is generous; the point of the
...
private let WORK_QUEUE = DispatchQueue(
  label: "se.agilator.baby.icloud-store", qos: .utility
)
