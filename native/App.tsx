...
// a website. Those two are that it serves the baby log FROM INSIDE THE
...
// the top bar pads itself down with `env(safe-area-inset-top)`, and the bottom
// navigation runs to the screen edge with the home indicator floating over its
// padding — which is how the installed PWA looks. Framing the WebView inside
// the safe area instead zeroes those insets and leaves two flat bands above
// and below the page, so the bars stop short of the status bar and the home
// indicator.
//
...
export default function App() {
  ...
  // wrapper keeps no copy of anybody's record.
  ...
  // app, the privacy policy's own links — belongs in the system browser,
    ...
    return (
      <SafeAreaProvider>
        <SafeAreaView style={styles.center}>
          ...
          <Text style={styles.errorTitle}>Could not start Baby</Text>
      ...
      >
        ...
        {origin ? (
          <WebView
            ...
            // which is where the working copy of the record lives.
            domStorageEnabled
