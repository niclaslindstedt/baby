...
Baby ships on the **App Store** alone: no desktop shell, no Mac record, no
...
- `listing.mts` — **committed.** The rules: which storefronts this app ships
...
1. **Exact rasters.** Each device shoots at its true CSS viewport and
   ...
   viewport actually gets (this app is laid out for portrait). The final PNG's
