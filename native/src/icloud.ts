...
// things the browser cannot: it serves the baby log from inside the
...
//
// What this module is NOT allowed to do is decide anything about the baby
// log. It moves bytes: a file in, a file out. What a feed, a weighing or a
// diaper is, and how two devices' edits reconcile, are all the web app's
// (`src/app/migrations.ts`, `merge.ts`) — a Swift copy of any of that is
