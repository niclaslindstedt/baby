...
# Regenerate native/ios and native/android from app.config.js. Both are
# gitignored build output — this is only for inspecting what prebuild writes.
native-prebuild:
